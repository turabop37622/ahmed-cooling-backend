...
const SERVICES = [
  ...
  { name: 'Washer Motor Repair', nameAr: 'إصلاح محرك الغسالة', description: 'Washing machine motor diagnosis, repair & replacement', descriptionAr: 'تشخيص وإصلاح واستبدال محرك الغسالة', icon: '⚙️', basePrice: 4000, category: 'washing-machine', isPopular: false, isEmergency: false, estimatedDuration: '2-4 hours', warrantyDays: 30 },
  { name: 'Dryer Repair', nameAr: 'إصلاح المجفف', description: 'Clothes dryer repair — heating element, motor & drum issues', descriptionAr: 'إصلاح مجفف الملابس', icon: '🔥', basePrice: 3000, category: 'washing-machine', isPopular: false, isEmergency: false, estimatedDuration: '2-3 hours', warrantyDays: 30 },
  ...
  { name: 'Gas Leak Detection', nameAr: 'كشف تسرب الغاز', description: 'Professional gas leak detection & pipeline safety check', descriptionAr: 'كشف تسرب الغاز وفحص سلامة الأنابيب', icon: '🔍', basePrice: 1000, category: 'stove', isPopular: false, isEmergency: true, estimatedDuration: '1 hour', warrantyDays: 7 },
  ...
  { name: 'Water Heater Repair', nameAr: 'إصلاح سخان المياه', description: 'Electric & gas geyser repair, element & thermostat replacement', descriptionAr: 'إصلاح سخان المياه الكهربائي والغازي', icon: '🚿', basePrice: 2000, category: 'general', isPopular: false, isEmergency: false, estimatedDuration: '1-2 hours', warrantyDays: 15 },
